...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->Private = (gcnew System::Windows::Forms::DataGridViewTextBoxColumn());
			...
			this->ViewRoomList->Columns->AddRange(gcnew cli::array< System::Windows::Forms::DataGridViewColumn^  >(4) {
				this->RoomIndex,
					this->RoomName, this->Private, this->CreatedDate
			});
			...
			// Private
			// 
			this->Private->HeaderText = L"Private";
			this->Private->MinimumWidth = 8;
			this->Private->Name = L"Private";
			this->Private->Width = 150;
			// 
			// CreatedDate
			// 

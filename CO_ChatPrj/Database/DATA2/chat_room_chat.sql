...
CREATE TABLE `room_chat` (
  `Room_Chat_Index` int NOT NULL AUTO_INCREMENT,
  `Member_ID` varchar(45) NOT NULL,
  `Chat` varchar(500) NOT NULL,
  `Chat_Date` datetime NOT NULL,
  `Room_Index` int NOT NULL,
  PRIMARY KEY (`Room_Chat_Index`),
  KEY `room_Index_idx` (`Room_Index`),
  CONSTRAINT `room_Index` FOREIGN KEY (`Room_Index`) REFERENCES `room_list` (`Room_Index`) ON DELETE CASCADE ON UPDATE CASCADE
...
-- Dump completed on 2023-10-23  0:00:13
